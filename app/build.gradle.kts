...
android {
	...
	namespace = "com.zsoltbertalan.signinflower"

	defaultConfig {
		applicationId = "com.zsoltbertalan.signinflower"
		...
		compileSdk = 34
		targetSdk = 34
		testInstrumentationRunner = "com.zsoltbertalan.signinflower.SignInFlowerAndroidJUnitRunner"
	}
...
tasks.withType<org.jetbrains.kotlin.gradle.tasks.KotlinCompile>().configureEach {
	kotlinOptions.freeCompilerArgs += "-opt-in=com.arkivanov.mvikotlin.core.utils.ExperimentalMviKotlinApi"
}
