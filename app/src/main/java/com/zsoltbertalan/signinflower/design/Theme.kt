package com.zsoltbertalan.signinflower.design
...
val SignInFlowerLightColorScheme = lightColorScheme(
...
private val SignInFlowerDarkColorScheme = darkColorScheme(
...
private val LocalAppColors = staticCompositionLocalOf {
	SignInFlowerLightColorScheme
}

@Composable
fun SignInFlowerTheme(
	...
	val colorScheme = when {
		...
		isDarkTheme -> SignInFlowerDarkColorScheme
		else -> SignInFlowerLightColorScheme
	}
	...
	ProvideDimens(dimensions = dimensions) {
		ProvideColors(colorScheme = colorScheme) {
			MaterialTheme(
				colorScheme = colorScheme,
				typography = SignInFlowerTypography,
				content = content
			)
		}
	}
...
val Dimens: Dimensions
	@Composable
	get() = SignInFlowerTheme.dimens

val Colors: ColorScheme
	@Composable
	get() = SignInFlowerTheme.colorScheme
